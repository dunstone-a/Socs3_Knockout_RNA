...
date: "`r Sys.Date()`"
author: "Millie Dunstone and Natalie Koh"
editor_options:
...
```{r}
# There are no genes that are expressed in no samples
...
dim(dge)
# We have removed 140 genes using filterByExpr.
...
The first dimension captures the most amount of information about the data, while the second dimension captures the next biggest proportion of variation. 
