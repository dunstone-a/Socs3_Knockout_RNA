...
We will be including `r nrow(dge)` genes in our differential expression analyses.
...
Multiple testing correction makes the threshold for p-values stricter to account for this. 
